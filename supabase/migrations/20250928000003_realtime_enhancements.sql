-- Real-time Data Enhancement Migration
-- This migration adds support for automatic real-time market data updates and sync tracking
...
ALTER TABLE positions
  ADD COLUMN IF NOT EXISTS last_price_update TIMESTAMPTZ,
  ADD COLUMN IF NOT EXISTS price_source TEXT DEFAULT 'manual' CHECK (price_source IN ('manual', 'yfinance', 'tiingo', 'api', 'sync'));

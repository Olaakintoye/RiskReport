...
const PortfolioScreen: React.FC = () => {
  ...
  const [portfolioToEdit, setPortfolioToEdit] = usePersistentState<PortfolioSummary | null>('PortfolioScreen', 'portfolioToEdit', null);
  
  // New state for details sheet
  const [detailsSheetVisible, setDetailsSheetVisible] = useState(false);
  const [selectedPortfolio, setSelectedPortfolio] = usePersistentState<Portfolio | null>('PortfolioScreen', 'selectedPortfolio', null);
